...
function ProductSelection() {
  ...
  useEffect(() => {
    setKycStatus(localStorage.getItem("kycStatus") || "not_started");
  }, []);
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-80 bg-gradient-to-b from-blue-600 to-blue-500 text-white flex flex-col">
        ...
        <nav className="flex-1 px-4">
          <button className="px-6 py-4 rounded-lg bg-white text-blue-600 w-full text-lg mb-2">
            Explore
          </button>
          <button className="px-6 py-4 rounded-lg hover:bg-blue-700 w-full text-lg">
            Help & Support
          </button>
        </nav>
        ...
        <div className="px-4 pb-6">
          <button
            ...
            className="px-6 py-4 rounded-lg hover:bg-red-500 w-full text-lg"
          >
            Logout
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-12">
          ...
          {kycStatus === "approved" && (
            <div className="max-w-4xl mx-auto mb-8 bg-green-50 border-l-4 border-green-400 p-4 flex items-center">
